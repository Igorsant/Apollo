...
import { Box, Theme, Grid, Container, Checkbox, FormControlLabel } from "@mui/material";
...
const CadastroProfissional = () => {
  ...
  const handleRemoveService = (index: number) => {
    form.services.length > 1 && setForm(current => ({
      ...current,
            ...
            <Grid item xs={12} md={12} container rowGap={3}>
              ...
              {form.services.map((service, index) => (
                <Grid item container xs={12} md={12} spacing={2} rowGap={3}>
                  ...
                  <Grid item xs={1} md={1}>
                    <PlusButton variant="contained" onClick={handlePushService}>+</PlusButton>
                  </Grid>
                </Grid>
              ))}
              <Grid item xs={12} md={12}>
                <table>
                  ...
                  {form.services.map((service, index) => (
                    <tr>
                      ...
                      <td>{service.price}</td>
                      <td>{service.time}</td>
                      <td><Button onClick={() => handleRemoveService(index)}>remove</Button></td>
                    </tr>
                  ))}
                </table>
              </Grid>
              ...
              <Grid item xs={12} md={12} container spacing={2} rowGap={2}>
                ...
                <Grid item xs={12} md={6}>
                  <TextInputLaranja
                    ...
                    onChange={(e) => handlePhoneChange(e, { number: e.target.value, isWpp: form.telefone1.isWpp })}
                    label={"Telefone 1"}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <TextInputLaranja
                    ...
                    onChange={(e) => handlePhoneChange(e, { number: e.target.value, isWpp: form.telefone2.isWpp })}
                    label={"Telefone 2"}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                <FormControlLabel
                    ...
                    control={<Checkbox 
                      ...
                      onChange={(e) => handlePhoneChange(e, { number: form.telefone1.number, isWpp: e.target.checked})} 
                    />}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <FormControlLabel
                    ...
                    control={<Checkbox 
                      ...
                      onChange={(e) => handlePhoneChange(e, { number: form.telefone2.number, isWpp: e.target.checked })} 
                    />}
                  />
                </Grid>
              </Grid>
